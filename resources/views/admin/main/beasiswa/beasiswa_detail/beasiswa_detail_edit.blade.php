                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data"
                                    action="{{route('beasiswa_detail_update')}}">
                                    @csrf
                                    <input type="hidden" name="dbd_id" value="{{$data->dpd_id}}">
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-md-2 col-form-label">Nama
                                            Beasiswa</label>
                                        <div class="col-md-10">
                                        <input class="form-control" type="text" name="dpd_title" value="{{$data->dbd_title}}"
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-md-2 col-form-label">Isi
                                            Beasiswa</label>
                                        <div class="col-md-10">
                                            <textarea name="dbd_description" id="editor1">
                                                {{$data->dbd_description}}
                                            </textarea>
                                        </div>
                                    </div>
                                    <div class="mt-4">
