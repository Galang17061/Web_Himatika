                            ...
                            <div class="card-body">
                                <form class="form_save">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="text" name="dod_category" value=""
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-md-2 col-form-label">Nama
                                            Olimpiade</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="text" name="dod_title" value=""
                                                id="example-text-input">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="text" name="dod_description" value=""
                                                id="example-text-input">
                                        </div>
                                    </div>
                                    <div class="mt-4">
...
<script>
   ...
   function save(argument) {
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "post",
                url:"{{ route('olimpiade_detail_save') }}",
