        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title mb-1">Departement Sport and Art Development</h4>
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Master</a></li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Departement</a></li>
                            <li class="breadcrumb-item active">Update Profil SAD</li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form_save" action="{{route('backend_SAD_update')}}" method="post"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="file" class="dropify" name="image" id="image"
                                                data-default-file="{{url(Storage::url('images/departement/SAD.jpg'))}}" />
                                        </div>
                                    </div>
