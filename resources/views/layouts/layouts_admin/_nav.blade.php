        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{route('home')}}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{asset('../assets_backend/images/logo-sm-dark.png')}}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{asset('../assets_frontend/main/hima/griya_rekasa.jpg')}}" alt="" height="100">
                    </span>
                </a>

                <a href="{{route('home')}}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{asset('../assets_backend/images/logo-sm-light.png')}}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{asset('../assets_backend/images/logo-light.png')}}" alt="" height="20">
                    </span>
                </a>
            </div>
